...
void loop()
{
  ...
  vel = 1.5*(stretch/(T/2)); // Beause 1/3 of the time is used for accelerating, 1/3 is used for constant velocity, and 1/3 is used for decelerating.
  accel = vel/(T/6);
...
{  
  ...
  M2.setAcceleration(a);
  M3.setAcceleration(a);
  M4.setAcceleration(a);
}
void OLED_display()
{
  display.clearDisplay();
